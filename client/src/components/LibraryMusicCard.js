    ...
    <div className="lib-music-card" key={index}>
      ...
      <div className="lib-actions">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="hub spotify"
        >
          <FontAwesomeIcon icon={faSpotify} />
        </a>
        <a
          href={songData.itunes}
          target="_blank"
          rel="noopener noreferrer"
          className="hub itunes"
        >
          <FontAwesomeIcon icon={faItunes} />
        </a>
        <a
          href={songData.deezer}
          target="_blank"
          rel="noopener noreferrer"
          className="hub deezer"
        >
          <FontAwesomeIcon icon={faDeezer} />
        </a>
        <a
          href={songData.shazam}
          target="_blank"
          rel="noopener noreferrer"
          className="hub shazam"
        >
          <svg
            viewBox="0 0 24 24"
            fill="currentColor"
